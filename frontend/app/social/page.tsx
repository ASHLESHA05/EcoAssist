    ...
    <div className="container mx-auto py-6 space-y-6">
      <div className="flex flex-col gap-2">
        ...
        <p className="text-muted-foreground">
          Connect with friends and join sustainability challenges
        </p>
      </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <Card>
              <CardHeader>
                ...
                <CardDescription>
                  Join these challenges to earn more points
                </CardDescription>
              </CardHeader>
              <CardContent>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <Card>
              <CardHeader>
                ...
                <CardDescription>
                  Connect with people who share your sustainability goals
                </CardDescription>
              </CardHeader>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <CardContent>
                <div className="grid grid-cols-3 gap-4">
                  {[
                    ...
                    {
                      name: "Water Guardian",
                      description: "Saved 1000 gallons",
                      icon: Award,
                    },
                    {
                      name: "Eco Shopper",
                    ...
                    <div
                      key={index}
                      className="flex flex-col items-center text-center p-2 bg-card border rounded-lg"
                    >
            ...
            <Card>
              <CardHeader>
                ...
                <CardDescription>
                  Complete these actions to earn more badges
                </CardDescription>
              </CardHeader>
              <CardContent>
                <div className="space-y-4">
                  {[
                    ...
                    },
                    {
                      ...
                      description: "Cook 20 plant-based meals",
                      progress: 40,
                    },
                    {
                      name: "Green Commuter",
                      description: "30 days of eco-friendly travel",
                      progress: 20,
                    },
                    {
                      name: "Energy Master",
                      description: "Use 100% renewable energy",
                      progress: 10,
                    },
